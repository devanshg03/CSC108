...
module: computer_play_functions

This code is provided solely for the personal and private use of students
taking the course CSC108/CSCA08 at the University of Toronto.  Copying for
purposes other than this use is expressly prohibited.  All forms of
distribution of this code, whether as given or with any changes, are expressly
prohibited.
...
# This file contains functions that allow for human vs. computer play.
# The computer strategy is to make random guesses.
